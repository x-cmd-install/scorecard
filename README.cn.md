...
[![x-cmd/install — scorecard Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/scorecard.svg?lang=zh)](https://x-cmd.com/install/scorecard)
...
合计: **84,216** 行代码（覆盖前 5 种语言、共 **753** 个文件）。
...
- **上游仓库**: <https://github.com/ossf/scorecard>
- **官网**: <https://scorecard.dev>
- **许可证**: Apache-2.0
...
- **Star**: 5,700 · **Fork**: 724 · **开放 issue**: 1,264 · **贡献者**: 209
...
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-24 | 0 | 1 | 24 | 1 | 10 | 2 |
| last60d | 2026-07-25 | 0 | 6 | 41 | 3 | 17 | 14 |
| 90d | 2026-06-25 | 0 | 14 | 54 | 4 | 19 | 15 |
| last180d | 2026-03-27 | 1 | 35 | 64 | 7 | 34 | 38 |
| 360d | 2025-09-28 | 3 | 127 | 68 | 16 | 44 | 125 |
| last720d | 2024-10-03 | 7 | 341 | 68 | 66 | 81 | 349 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/scorecard.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260923.yml` · 2026-09-23T06:43:26Z._
